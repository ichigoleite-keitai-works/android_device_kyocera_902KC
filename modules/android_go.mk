...
$(call inherit-product, device/kyocera/902KC/build/AndroidGo512.mk)
else
$(call inherit-product, build/target/product/go_defaults_512.mk)
$(call inherit-product, device/kyocera/902KC/build/AndroidGo512.mk)
...
$(call inherit-product, device/kyocera/902KC/build/AndroidGoCommon.mk)

# Copy features to device
PRODUCT_COPY_FILES += \
    device/kyocera/902KC/permissions/android.hardware.ram.low.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.ram.low.xml
...
# Overlay configs
DEVICE_PACKAGE_OVERLAYS += device/kyocera/902KC/overlay_go
